...
def main() -> None:
    ...
    parser.add_argument("--script", type=Path, default=Path("script_submission_v23_qwen_tree_blend.py"))
    parser.add_argument("--feature-utils", type=Path, default=Path("feature_utils_qwen_v4.py"))
    parser.add_argument("--stage-dir", type=Path, default=Path("submit_stage_v23_qwen_tree_blend"))
    parser.add_argument("--zip-path", type=Path, default=Path("submit_v23_qwen_tree_blend.zip"))
    ...
    print("V23 Qwen + LightGBM tree blend structure and size checks passed.")
