# V14 action8 variant: preserves V4 structured features and token budgets; only expands recent action text from 4 to 8.
import json
import math
import re
...
def build_segments(sample: Dict[str, Any]) -> Dict[str, str]:
    ...
    recent_actions = state["action_items"][-8:]
