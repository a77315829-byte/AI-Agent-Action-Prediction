"""
screen_file_search_specialist.py
...
GROUP = ["read_file", "grep_search", "list_directory", "glob_pattern"]
...
def build_specialist_oof(
    ...
    for fold, (train_idx, val_idx) in enumerate(
        ...
        full_proba = np.zeros((len(val_idx), 4))
        ...
        if group_true_val_mask.any():
            ...
            print(f"  Fold {fold}/{n_splits}: 4-way macro_f1 (on true-group val rows)={fold_f1:.6f}")
